...
% \label{ch:intro}
%     \include{1_Intro/introduction_chapter}

% \chapter{The Long-Range Falikov-Kimball Model}
% \label{ch:fk_model}
%     \include{2_FK_Model/fk_model_chapter}

\chapter{The Amorphous Kitaev Honeycomb Model}
\label{ch:kitaev_model}
    % \include{3_Kitaev_Model/standard_kitaev_model}
    \include{3_Kitaev_Model/AMK}

% \chapter{Conclusion \& Discussion}
% \label{ch:conclusion}
%     \include{4_Conclusion/conclusion_chapter}
