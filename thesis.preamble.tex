...
%fix warning about e with tail
\DeclareUnicodeCharacter{0229}{\c{e}}

\usepackage[x11names, rgb, html]{xcolor} % load xcolor with options that match solarized.sty before it gets loaded by any other package
\usepackage{graphicx}% Include figure files
\DeclareGraphicsExtensions{.pdf,.png,.jpg,.jpeg} % bare includegraphics calls will try to find files in this order
...
\usepackage{tikz}
\usepackage[labelfont=bf,textfont=small]{caption} %make figure caption labels bold
...
\usepackage{float}
\floatplacement{figure}{t} % figure placement specifier: t means at the top of the page
...
%to be able to use %smaller and the like
\usepackage{relsize}
...
%ignore warning about the fact that the bibtex style sheet doesn't know what to do with
%@video
...
\definecolor{urlblue}{HTML}{00008b}
