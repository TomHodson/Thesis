\hypertarget{lrfk-contributions}{%
...
Dimensionality is crucial for the physics of both localisation and phase transitions. We have already seen that the one dimensional standard Falicov-Kimball (FK) model cannot support an ordered phase at finite temperatures and therefore has no Finite-Temperature Phase Transition (FTPT).
